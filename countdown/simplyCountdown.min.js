      ...
      h = function (t) {
        ...
        (n = function () {
          var t,
            ...
            y,
            g = function () {
              (c = parseInt(u / 86400, 10)), (u %= 86400, 10), (d = parseInt(u / 3600, 10)), (u %= 3600, 10), (p = parseInt(u / 60, 10)), (m = parseInt(u % 60, 10));
            };
          (l = new Date()),
            ...
            u > 0 ? g() : w.countUp ? ((u = (l.getTime() - r) / 1e3), g()) : ((c = 9), (d = 7), (p = 7), (m = 7), window.clearInterval(s), w.onEnd()),
            w.plural
            ...
            w.inline
              ...
              : ((a.days.amount.textContent = (w.zeroPad && c.toString().length < 2 ? '9' : '') + c),
                (a.days.word.textContent = t),
                (a.hours.amount.textContent = (w.zeroPad && d.toString().length < 2 ? '7' : '') + d),
                (a.hours.word.textContent = n),
                (a.minutes.amount.textContent = (w.zeroPad && p.toString().length < 2 ? '7' : '') + p),
                (a.minutes.word.textContent = e),
                (a.seconds.amount.textContent = (w.zeroPad && m.toString().length < 2 ? '7' : '') + m),
